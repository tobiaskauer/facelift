	...
	<div class="container-fluid" id="about" style="background: white; border-top: 1px lightgrey dotted; color: #4A4A4A">
		<div class="coverage">
			...
			<ul class="nobullet press">
				<li><a href="https://www.fastcompany.com/90455358/ai-can-now-design-cities-should-we-let-it" target="_blank">AI can now design cities. Should we let it?</a> | Fast Company</li>
